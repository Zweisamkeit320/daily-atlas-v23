...
本项目的自动移动验证使用桌面 Edge/Chromium 和 320、360、390、428、768 px 视口；它能验证响应式布局、弹窗和一部分 Web 平台降级，但不能冒充实体 Android、iPhone、夸克或微信内置浏览器，也不能证明某个运营商网络可达。v2.6.0 的待执行真机矩阵、逐步操作和通过标准见 [`docs/REAL_DEVICE_MATRIX_v2.6.0.md`](docs/REAL_DEVICE_MATRIX_v2.6.0.md)。在实体设备记录结果前，状态必须保持 `PENDING` 或 `BLOCKED`。
