...
- `catalog-data/selection-data.<hash>.json`：HTTP／PWA 首屏使用的 2,200 条紧凑选择记录；v2.6.0 当前为 377,102 B，gzip 78,826 B。加载器先通过 `assetFetcher` 完成字节数、SHA-256 与 SRI 校验，再重建全局选择目录。
