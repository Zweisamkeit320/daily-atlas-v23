...
const ROOT_FILES = Object.freeze([
  ...
  "LICENSE.txt", "NOTICE.txt", "manifest.webmanifest", "music.js", "package-lock.json", "package.json", "privacy.html", "profile.js", "public-config.js", "pwa.js", "README.md", "reminders.js", "requirements-assets.txt", "sources-and-licenses.html",
