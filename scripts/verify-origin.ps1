...
foreach ($check in @(
  ...
  [PSCustomObject]@{ Label = 'appVersion: "2.4.1"'; Pattern = 'appVersion\s*:\s*["'']2\.4\.1["'']' },
...
if ($catalogManifest.appVersion -ne "2.4.1") {
  throw "catalog-data/manifest.json appVersion must be 2.4.1."
}
