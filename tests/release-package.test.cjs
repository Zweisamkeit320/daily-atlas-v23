...
test("release package has one root, canonical sidecars, exact hashes, 500 MP3s, 200 reviewed city visuals, fresh six-pack versions, and no excluded paths", (t) => {
  ...
  for (const name of ["_headers", "LICENSE.txt", "NOTICE.txt", "bootstrap.js", "runtime-foundation.js", "runtime-features.js", "catalog-loader.js", "runtime-health.js", "search-worker.js", "diagnostics.html", "explore.js", "weekly.js", "backup-crypto.js", "asset-routing.js"]) {
...
test("release creation refuses a ZIP version that differs from package.json", (t) => {
  ...
  assert.throws(() => Release.createRelease(mismatched, fixture.root), /ZIP version 2\.0\.0 does not match package version 2\.6\.0/);
